...
<html lang="es">
  ...
  <body>
    <div class="container">
        <h1>Actualizar Regiones</h1>
        <a href="municipios"><button class="btn btn-danger">Pagina Regiones</button></a>
        <div class="formularios_contenedor">
        <form action="<?php echo base_url('actualizar_region'); ?>" method="post">
            <div class="mb-8">
            ...
            <div class="mb-8">
                <label for="txtNombre" class="form-label">Nombre de region:</label>
