...
<html lang="es">
  ...
  <body>
    <div class="container">
        ...
        <a href="departamentos"><button class="btn btn-danger">Pagina Niveles Academicos</button></a>
        <div class="formularios_contenedor">
        <form action="<?php echo base_url('agregar_nivelAcademico'); ?>" method="post">
            <div class="mb-8">
            ...
            <div class="mb-8">
                <label for="txtDescripcion" class="form-label">Decripcion:</label>
